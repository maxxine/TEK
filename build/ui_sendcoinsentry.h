...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        SendCoinsEntry->resize(729, 138);
        SendCoinsEntry->setStyleSheet(QString::fromUtf8("background-color: rgb(203, 203, 203);"));
        ...
        payAmount = new tekcoinAmountField(SendCoinsEntry);
