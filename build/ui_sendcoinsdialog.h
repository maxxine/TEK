...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        SendCoinsDialog->setStyleSheet(QString::fromUtf8("background-color: qlineargradient(spread:reflect, x1:0.496, y1:1, x2:0.493, y2:0.477273, stop:0 rgba(77, 77, 77, 255), stop:1 rgba(255, 255, 255, 255));"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 656, 107));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 TEK", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
