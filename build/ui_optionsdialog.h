...
**
** Created: Sun Sep 8 19:19:12 2013
...
public:
    ...
    tekcoinAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_Main;
    QCheckBox *tekcoinAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        OptionsDialog->setStyleSheet(QString::fromUtf8("background-color: qlineargradient(spread:reflect, x1:0.496, y1:1, x2:0.493, y2:0.477273, stop:0 rgba(77, 77, 77, 255), stop:1 rgba(255, 255, 255, 255));"));
        ...
        transactionFee = new tekcoinAmountField(tabMain);
        ...
        tekcoinAtStartup = new QCheckBox(tabMain);
        tekcoinAtStartup->setObjectName(QString::fromUtf8("tekcoinAtStartup"));

        verticalLayout_Main->addWidget(tekcoinAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        tekcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start tekcoin after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        tekcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start tekcoin on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the tekcoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the tekcoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting tekcoin.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show tekcoin addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
