...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        AboutDialog->setStyleSheet(QString::fromUtf8("background-color: qlineargradient(spread:reflect, x1:0.496, y1:1, x2:0.493, y2:0.477273, stop:0 rgba(77, 77, 77, 255), stop:1 rgba(255, 255, 255, 255));"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About tekcoin", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("AboutDialog", "<b>tekcoin</b> version", 0, QApplication::UnicodeUTF8));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2013 The tekcoin Foundation\n"
"         http://www.tekcoin.com", 0, QApplication::UnicodeUTF8));
