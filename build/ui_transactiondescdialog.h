...
public:
    ...
    void setupUi(QDialog *TransactionDescDialog)
    {
        ...
        TransactionDescDialog->setStyleSheet(QString::fromUtf8("background-color: qlineargradient(spread:reflect, x1:0.496, y1:1, x2:0.493, y2:0.477273, stop:0 rgba(77, 77, 77, 255), stop:1 rgba(255, 255, 255, 255));"));
